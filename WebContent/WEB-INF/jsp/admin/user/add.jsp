			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<span style="color: red"><strong>${msg}</strong></span>
						<form class="form-horizontal" action="${pageContext.request.contextPath }/admincp/user/add" method="post">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="focusedInput" >Username</label>
								<div class="controls">
								  <input class="input-xlarge focused" name="username" id="focusedInput" type="text" value=""  placeholder="Nhập username" >
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="password" id="focusedInput" type="password" value=""  placeholder="Nhập mật khẩu" >
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="fullname" id="focusedInput" type="text" value=""  placeholder="Nhập fullname" >
