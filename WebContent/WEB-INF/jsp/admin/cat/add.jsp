			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<span style="color: red"><strong>${msg}</strong></span>
						<form class="form-horizontal" action="${pageContext.request.contextPath }/admincp/cat/add" method="post">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="focusedInput" >Danh mục</label>
								<div class="controls">
								  <input class="input-xlarge focused" name="name" id="focusedInput" type="text" value=""  placeholder="Nhập danh mục" >
