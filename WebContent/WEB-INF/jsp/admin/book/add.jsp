			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<span style="color: red"><strong>${msg}</strong></span>
						<form class="form-horizontal" action="${pageContext.request.contextPath }/admincp/book/add" method="post" enctype="multipart/form-data">
							<fieldset>
							  <div class="control-group">
								<label class="control-label" for="focusedInput" >Tên sách</label>
								<div class="controls">
								  <input class="input-xlarge focused" name="name" id="focusedInput" type="text" value=""  placeholder="tên" >
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="quantity" id="focusedInput" type="text" value=""  placeholder="số lượng" >
							   ...
							   <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" name="cost" id="focusedInput" type="text" value=""  placeholder="giá" >
